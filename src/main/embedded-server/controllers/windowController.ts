...
// Get all windows
export const getAllWindows = asyncHandler(async (_req: Request, res: Response) => {
...
export const createWindowWithAutoNumber = asyncHandler(async (_req: Request, res: Response) => {
  try {
...
export const getActiveWindows = asyncHandler(async (_req: Request, res: Response) => {
